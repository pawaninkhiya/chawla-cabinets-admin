...
import { useUpdateProductColorOptionMutation, useAddProductColorOptionMutation } from "@services/apis/products/hooks";
            ...
            <div className="relative">
                ...
                <div className="flex gap-2 mb-4">
                    <button
                        ...
                        onClick={() => { setMode("edit"); setIsModalOpen(true); }}
                    >
                        Edit Color
                    </button>
                    <button
                ...
                {selectedColor?.images?.length > 0 && (
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {selectedColor.images.map((image, imgIndex) => (
                            <div key={imgIndex} className="border border-gray-200 rounded-lg overflow-hidden relative">
            ...
            <Modal open={isModalOpen} onClose={() => setIsModalOpen(false)} width="max-w-3xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        <Button type="button" text="Cancel" bgColor="bg-gray-400 hover:bg-gray-500" onClick={() => setIsModalOpen(false)} />
